<?php
     ...
     * @return  string
     */
    function main($str, $is_image = FALSE)
    {
         ...
         */
        $str = preg_replace_callback("/[^a-z0-9>]+[a-z0-9]+=([\'\"]).*?\\1/si", array(main($str), '_convert_attribute'), $str);
        $str = preg_replace_callback('/<\w+.*/si', array(main($str), '_decode_entity'), $str);
